...
# Get detailed WiFi information using system_profiler for signal strength and speed
...
# Format is: "Signal / Noise: -71 dBm / -93 dBm"
...
# Update popup items with detailed information
sketchybar --set wifi.ssid \
    label.string="$SSID"

sketchybar --set wifi.speed \
    label.string="$SPEED"
